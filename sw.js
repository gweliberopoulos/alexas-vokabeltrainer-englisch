...
const ASSETS = [
  ...
  BASE + 'data/en/archiv/unit1-checkout-story.json',
  BASE + 'data/en/archiv/unit1-text-smart.json',
  BASE + 'data/en/archiv/unit2-welcome-station1.json',
  BASE + 'data/en/archiv/unit2-station2.json',
  BASE + 'data/en/archiv/unit2.json',
  BASE + 'data/en/archiv/unit2-story-checkin.json',
  BASE + 'data/en/archiv/unit3-checkin.json',
  BASE + 'data/en/archiv/unit3-checkout.json',
